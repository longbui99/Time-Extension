            ...
            for (let group in historyByDate){
                ...
                for (let log of values){
                    let eachLogHTML =  `<div class="log-each" data-group="${group}" data-id="${log['id']}">
                            ...
                            <span class="wl-circle-decorator" title="${log.start_date || ''}"><i class="fas fa-circle"></i></span>
        ...
        <div class="issue search-bar">
            <div class="input-group justify-content-between">
                <span class="icon-prepend" l-ref="reload-issue" tabindex="999" title="Reload From The Original Server">
                    <div class="tm-icon-svg button-segment favorite" l-ref="favorite-segment-ref">
